...
describe("Acto Local Storage", () => {
    test("should set the storage key to 'steve-https://testactoapp.com/fun'", () => {
        ...
        let configObj = { 'mock': 0 };
        let page = 'https://testactoapp.com/fun';
        let AS = new ActoLocalStorage();
        AS.init(configObj, page, prefix);
        expect(JSON.stringify(ALS.get())).toBe(`{"mock":0}`);
    });
    ...
    test("should return all key / value pairs that start with 'acto-'", () => {
        ...
        expect(objs).toStrictEqual({
            "acto-time-https://testactoapp.com/fun0": "{\"mock\":0}",
            "acto-time-https://testactoapp.com/fun1": "{\"mock\":1}",
            "acto-time-https://testactoapp.com/fun10": "{\"mock\":10}",
            "acto-time-https://testactoapp.com/fun2": "{\"mock\":2}",
            "acto-time-https://testactoapp.com/fun3": "{\"mock\":3}",
            "acto-time-https://testactoapp.com/fun4": "{\"mock\":4}",
            "acto-time-https://testactoapp.com/fun5": "{\"mock\":5}",
            "acto-time-https://testactoapp.com/fun6": "{\"mock\":6}",
            "acto-time-https://testactoapp.com/fun7": "{\"mock\":7}",
            "acto-time-https://testactoapp.com/fun8": "{\"mock\":8}",
            "acto-time-https://testactoapp.com/fun9": "{\"mock\":9}",
            "acto-time-https://testactoapp.com/fun": "{\"mock\":0}",
        });
    });
});
